...
public class Player2 {
	...
	public Player2 (int id, int score, String ptype, String lastmove, int points) {
		this.id=id;
		this.score=score;
		this.ptype=ptype;
	...
	public static void calcScore(Player2 a, Player2 b) {
	...
	public static void reset(Player2 [] array) {
	...
	public static void points(int[] array, Player2[]rank) {
		for (int i=0;i<array.length;i++) {
			rank[i].setPoints(array[i]);
		}
	}

	public static Player2[] sortArray(Player2[]array) {
		Player2 temp;
		for (int i=0;i<array.length;i++) {
	...
	public static int getMin(Player2 []array) {
	...
	public static int getMax(Player2 []array) {
	...
	public List<Integer> findIndices(Player2[]array) {
	...
	public static void removeBot(Player2[]array, int p) {
		Player2 delete=new Player2(0,0,"fix","",0);
	...
	public static int countMax(Player2[]array, int max) {
		int counter=0;
		for (int i=0;i<array.length;i++) {
			if (array[i].getPoints()==max) {
				counter++;
	...
	public static Player2[] replaceTop(Player2[] array,int p) {
		int pindex=(int) (array.length*((double)p/100));
		//		int pindex=2;
		ArrayList<Player2> top = new ArrayList<Player2>();
		ArrayList<Integer>indices=new ArrayList<Integer>();
		for (int i=0;i<pindex;i++) {
			indices.add(i);
		}
	...
	public static void main(String[] args) {
		...
		int k=20; 
		int m=5;
		Player2 [] list = new Player2[n];
		String[] moves= {"cooperate","defect"};
		//populate list of Player2s array 
		for(int i=0;i<3;i++) {
			String ptype="";
			String lastmove="";
			ptype="g";
			lastmove="cooperate";
			list[i]=new Player2(i, 0,ptype,lastmove,0);
		}
		for (int i=3;i<n;i++) {
			String ptype="";
			String lastmove="";
